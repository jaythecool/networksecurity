...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)-> Pipeline:
        logging.info("Entered get_data_tramsformer_object method of transformation class")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            transformed_inputput_test_feature = preprocessor.transform(input_feature_test_df)

            train_arr = np.c_[transformed_input_train_feature,np.array(target_feature_train_df)]
            test_arr = np.c_[transformed_inputput_test_feature,np.array(target_feature_test_df)]

            # save numpy array data
            save_numpy_array(self.data_transformation_config.transformed_trained_file_path,array=train_arr)
